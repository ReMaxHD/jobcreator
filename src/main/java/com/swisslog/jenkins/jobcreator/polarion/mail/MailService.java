 ...
 * URL             : $URL: http://almscdc.swisslog.com/repo/SWPD/Development/WM6/trunk/Software/WM6/wm6-tools/jenkins-jobcreator/src/main/java/com/swisslog/jenkins/jobcreator/polarion/mail/MailService.java $
 * 
 * -----------------------------------------------------------------------------
 * Copyright
...
/**
 * Use this interface to notify the user after the jobcreation finished
 */
public interface MailService {
     ...
     * 
     * @param recipients
     *            the addresses to which this mail should be send
     * @param subject
     *            the subject
     * @param content
     *            the mail content
     */
    void sendMail(String[] recipients, String subject, String content);
}